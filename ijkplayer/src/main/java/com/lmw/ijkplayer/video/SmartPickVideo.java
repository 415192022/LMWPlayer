...
import com.lmw.ijkplayer.view.LoadingDialog;
import com.lmw.ijkplayer.view.SwitchVideoTypeDialog;
...
public class SmartPickVideo extends StandardGSYVideoPlayer {
    ...
    public void setMute(boolean bool) {
        SmartPickVideo.isMute = bool;
        if (SmartPickVideo.isMute) {
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        sampleVideo.setMute(SmartPickVideo.isMute);
        return sampleVideo;
    }
